      ...
      {loading ? (
        ...
        <div>
          <HeroSection 
            ...
            onShowPoster={() => setShowPosterModal(true)}
          ...
          {activeTab === 'overview' && (
            <>
              ...
              <MovieRecommendations currentMovieId="tt3896198" />
            </>
          )}
          ...
          {activeTab === 'cast' && (
            <CastSection 
              cast={mainCast}
              data-testid="cast-section-expanded"
            />
          )}
          
          {activeTab === 'videos' && (
            <VideosSection onOpenTrailer={() => setShowTrailerModal(true)} />
          )}
          
          {activeTab === 'reviews' && (
            <ReviewsSection movieTitle={movieData.Title} />
          )}
