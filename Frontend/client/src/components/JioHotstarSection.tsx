...
export default function JioHotstarSection({ movieTitle }: JioHotstarSectionProps) {
  return (
    <section className="py-16 bg-gradient-to-r from-purple-900 via-blue-900 to-purple-900 opacity-0 animate-fade-in" style={{animationDelay: '1.5s', animationFillMode: 'forwards'}}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-white mb-4 opacity-0 animate-slide-in-up" style={{animationDelay: '1.7s', animationFillMode: 'forwards'}}>
            Watch Now on JioHotstar
          </h2>
          <p className="text-xl text-gray-200 mb-8 opacity-0 animate-slide-in-up" style={{animationDelay: '1.9s', animationFillMode: 'forwards'}}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Left side - Features */}
          <div className="space-y-6 opacity-0 animate-slide-in-up" style={{animationDelay: '2.1s', animationFillMode: 'forwards'}}>
            <div className="flex items-center space-x-4">
              <div className="w-12 h-12 bg-gradient-to-r from-pink-500 to-orange-500 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg">
            ...
            <div className="flex items-center space-x-4">
              <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg">
            ...
            <div className="flex items-center space-x-4">
              <div className="w-12 h-12 bg-gradient-to-r from-green-500 to-teal-500 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg">
          ...
          {/* Right side - CTA */}
          <div className="text-center lg:text-left opacity-0 animate-slide-in-up" style={{animationDelay: '2.3s', animationFillMode: 'forwards'}}>
