...
export default function TrailerModal({ movieData, onClose }: TrailerModalProps) {
  return (
    <div 
      ...
      <div className="relative max-w-4xl w-full mx-4 animate-modal-slide-in" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="bg-card rounded-lg overflow-hidden shadow-2xl hover-lift">
  ...
  <button 
    className="bg-accent/20 backdrop-blur-sm border-2 border-accent rounded-full w-20 h-20 flex items-center justify-center hover:bg-accent/30 hover:scale-110 transition-all duration-300 animate-pulse"
